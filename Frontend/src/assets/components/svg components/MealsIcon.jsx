export function MealsIcon({ className }) {
  return (
    <>
      <svg className={className} version="1.1" id="_x32_" viewBox="0 0 512 512">
        <g>
          <path
            className="icon-path"
            fill="currentColor"
            d="M199.259,2.124c-10.736,0-17.97,8.514-17.97,19.002v90.51c0,10.292-5.288,15.216-13.403,15.216
		...
		z"
          ...
          <path
            className="icon-path"
            fill="currentColor"
            d="M332.341,209.087c13.384,11.838,19.526,16.575,19.526,30.182v34.288h48.818v-34.288
		...
		c-43.149,0-88.92,46.037-88.92,118.354C287.352,163.361,318.653,196.991,332.341,209.087z"
          ...
          <path
            className="icon-path"
            fill="currentColor"
            d="M177.831,287.44H93.649c-10.682,0-19.339,8.657-19.339,19.339s8.657,19.339,19.339,19.339h84.182
		c10.683,0,19.339-8.657,19.339-19.339S188.514,287.44,177.831,287.44z"
          />
          <path
            className="icon-path"
            fill="currentColor"
            d="M94.786,471.046c0,22.618,18.336,40.954,40.954,40.954c22.619,0,40.954-18.335,40.954-40.954V339.769H94.786
		V471.046z"
          />
          <path
            className="icon-path"
            fill="currentColor"
            d="M418.363,287.44H334.18c-10.683,0-19.339,8.657-19.339,19.339s8.656,19.339,19.339,19.339h84.182
		c10.682,0,19.339-8.657,19.339-19.339S429.045,287.44,418.363,287.44z"
          />
          <path
            className="icon-path"
            fill="currentColor"
            d="M335.318,471.046c0,22.618,18.335,40.954,40.954,40.954c22.619,0,40.954-18.335,40.954-40.954V339.769h-81.907
		V471.046z"
          />
        </g>
      </svg>
